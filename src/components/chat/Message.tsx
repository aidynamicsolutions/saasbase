      ...
      <div
        ...
        <div
          className={cn(
            'relative flex h-6 w-6 aspect-square items-center justify-center',
            {
              ...
              invisible: isNextMessageSamePerson, // make sure icon is only shown once
            }
          )}>
        ...
        <div
          className={cn(
            ...
            {
              // apply the "order-1 items-end" if message.isUserMessage is true
          ...
          <div
            ...
            {typeof message.text === 'string' ? (
              ...
              message.text // display jsx element here if not a string
            )}
